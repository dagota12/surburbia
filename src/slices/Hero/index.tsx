...
const DEFAULT_BOLT_COLOR = "#ff0000";
/**
 * Props for `Hero`.
 */
  ...
  return (
    ...
    >
      <div className="absolute inset-0 flex items-center pt-20">
        ...
        <TallLogo className="w-full text-brand-purple block lg:hidden opacity-20 mix-blend-multiply" />
      </div>
      {/**
       * MCP Server configuration for Prismic
       * {
       *   "mcpServers": {
       *     "Prismic MCP": {
       *       "command": "npx",
       ...
       * }
       */}
      <div className="absolute inset-0 mx-auto mt-16 grid max-w-6xl grid-rows-[1fr,auto] place-items-end px-6 py-10 md:py-12 lg:py-16">
        <Heading className="relative place-self-start max-w-xs md:max-w-2xl">
          <PrismicText field={slice.primary.heading} />
        </Heading>
        <div className="flex relative w-full flex-col items-center justify-between lg:flex-row gap-2">
